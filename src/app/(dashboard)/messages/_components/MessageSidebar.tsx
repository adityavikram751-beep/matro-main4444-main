...
import { Search, Users, User, X, LogOut } from "lucide-react";
...
export default function MessageSidebar({
  ...
  useEffect(() => {
    const fetchOnlineUsers = async () => {
      try {
        ...
        const res = await fetch(`${API_BASE_URL}/api/message/online`, {
  ...
  return (
    <aside className="h-full w-full bg-white border-r border-gray-200 flex flex-col fixed md:relative md:flex z-50">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm md:text-base"
          />
        </div>
      </div>
